...
\subsection{Sintaksa i semantika}
...
\subsection{Konjunktivna normalna forma.} \paragraph{Literal.} Promenljiva ($p$) ili njena negacija ($\neg p$).
\paragraph{Klauza.} Disjunkcija literala, npr.\ $(p \vee \neg q \vee r)$.
\paragraph{Definicija KNF.} Formula je u \emph{konjunktivnoj normalnoj formi} (KNF) ako je konjunkcija klauza. 


\section{Opis metode}
\label{sec:opis_metode}
% TODO: DP procedura radi isključivo nad formulama u KNF.
