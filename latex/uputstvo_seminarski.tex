...
Ulazna formula predstavlja se apstraktnim sintaksnim stablom preko \verb|std::variant| tipa \verb|Formula| (koji može biti \verb|False|, \verb|True|, \verb|Atom|, \verb|Not|, \verb|Binary|).
Prvo se koristi Tseytin transformacija da bi se formula
svela na KNF oblik, jer to zahteva DP procedura.
Za KNF koristimo sledeće tipove:
